...
class CardTests(unittest.TestCase):
    ...
    def test_defaulted_card(self):
        test_cards = [Card(None, None), Card('test', None), Card(11, 'Triangles'), Card(0, 'Triangles')]
    ...
    def test_value_is_int(self):
        test_cards = [Card(None, None), Card('test', None), Card(5, 'Circles'),
                      Card(11, 'Triangles'), Card(0, 'Triangles')]
    ...
    def test_is_staves_valid(self):
        ...
        test_cards = [Card(None, None), Card('test', None), Card(None, 'Circles'),
                      Card(5, 'Test Stave'), Card(0, 'Sylop'), Card(5, 'Sylop'), Card(0, 'Triangles')]
